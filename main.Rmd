...
Dataset<-initialise_dataset("Gradual3DRIFTS_W5K")   #c("COVID-SYN","Gradual_W10K", "Gradual3DRIFTS_W5K")

# Chose model and performance metric
Dataset$model_trained <- "random_forest"   #c("random_forest", "logistic_regression")
Dataset$performance_metric <- "accuracy"   #c("accuracy", "recall")
